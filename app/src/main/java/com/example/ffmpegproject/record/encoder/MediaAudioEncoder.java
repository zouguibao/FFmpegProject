...
public class MediaAudioEncoder extends MediaEncoder {
    ...
    public MediaAudioEncoder(MediaMuxerWrapper mediaMuxerWrapper, MediaEncoderListener listener) {
        ...
        public void run() {
            ...
            try {
                ...
                if (audioRecord != null) {
                    try {
                        if (mIsCapturing) {
                            MyLog.e("AudioThread:start audio recording");
                    ...
                    MyLog.e("failed to initialize AudioRecord");
                }
            } catch (final Exception e) {
                MyLog.e("AudioThread#run");
            }
            if (cnt == 0) {
                final ByteBuffer buf = ByteBuffer.allocateDirect(SAMPLES_PER_FRAME);
    ...
    private static final MediaCodecInfo selectAudioCodec(final String mimeType) {
        ...
        for (int i = 0; i < numCodecs; i++) {
            ...
            for (int j = 0; j < types.length; j++) {
                MyLog.e("supportedType:" + codecInfo.getName() + ",MIME=" + types[j]);
